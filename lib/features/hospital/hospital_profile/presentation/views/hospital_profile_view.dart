...
import 'package:locum_care/features/hospital/hospital_profile/presentation/views/widgets/hospital_profile_not_complete.dart';
              ...
              children: [
                _buildSectionHeader(
                  ...
                  handleEdit: () {
                    Navigator.of(
                      context,
                    ).pushNamed(AppRoutesNames.userHospitalForm, arguments: {'create': false});
                  },
                ),
              ...
              children: [
                _buildSectionHeader(
                  ...
                  handleEdit: () {
                    Navigator.of(
                      context,
                    ).pushNamed(AppRoutesNames.hospitalForm, arguments: {'create': false});
                  },
                ),
              ...
              children: [
                _buildSectionHeader(
                  ...
                  handleEdit: () {
                    Navigator.of(
                      context,
                    ).pushNamed(AppRoutesNames.hospitalInfoForm, arguments: {'create': false});
                  },
                ),
              ...
              builder: (context) {
                ...
                return _sectionCard(
                  children: [
                    ...
                    ...documents.map(
                      (document) => _buildDocumentRow(document.type ?? '', document.file ?? ''),
                    ),
                  ],
  ...
  Widget _buildDocumentRow(String docType, String docLink) {
    return Padding(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Text(docType, style: const TextStyle(fontWeight: FontWeight.w600)),
          GestureDetector(
            onTap: () {
